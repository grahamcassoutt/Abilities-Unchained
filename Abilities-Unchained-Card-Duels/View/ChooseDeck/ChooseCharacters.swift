    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                HStack {
                    Spacer()
                    CardHolderSelection(hasAbility: true, character: Character(_id: "1", name: "asdf", description: "asdf", backOfCardDescription: "back", photoUrl: "card11", unlockedAt: 2, characterStatistics: [CharacterStatistics(level: 1, health: 2, attack: 3, xpToUpgrade: 4, goldToUpgrade: 5)]))
                    Spacer()
